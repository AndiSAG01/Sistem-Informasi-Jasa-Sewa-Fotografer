...
@section('content')
    <section id="hero" class="hero d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-3 text-center">
                                ...
                                <div class="card-body text-white rounded fullscreen-bg "
                                    ...
                                    <p style="font-family: 'Times New Roman'; font-size:200%">FAMILLY PHOTO
                                    </p>
                                </div>
                            </div>
                            <div class="col-lg-8 text-center">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <img class="mb-4" src="asset/img/familly/fm1.jpg" alt=""
                                            width="400px">
                                        <img class="mb-4" src="asset/img/familly/fm4.jpg" alt=""
                                            width="400px">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card-body text-center">
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <img src="asset/img/familly/fm2.jpg" alt="" width="500px">
                                <img src="asset/img/familly/fm3.jpg" alt="" width="500px">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card-header mb-4" style="border: 1px solid white; padding:10px">
            <span style="font-family: 'Times New Roman'; font-size:200%">PACKAGE LISTS <b>FAMILLY PHOTO
                </b></span>
        </div>
        <div class="container py-4">
            <div id="preweddingCarousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    @foreach ($familly as $key => $pw)
                                ...
                                <div class="col-xl-5 col-sm-4 col-8">
                                    <div class="card mb-3 fullscreen-bg"
                                        ...
                                        <div class="card-body" style="color: white;">
                                            ...
                                            <a href="{{ route('reservation_familly', $pw->id) }}" class="btn btn-success">Reservation</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
