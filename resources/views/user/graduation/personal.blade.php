...
@section('content')
    <section id="hero" class="hero d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-3 text-center">
                                ...
                                <div class="card-body text-white rounded fullscreen-bg "
                                    ...
                                    <p style="font-family: 'Times New Roman'; font-size:200%">PERSONAL PHOTO
                                    </p>
                                </div>
                            </div>
                            <div class="col-lg-8 text-center">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <img class="mb-4" src="asset/img/personal/ps1.jpg" alt=""
                                            width="400px">
                                        <img class="mb-4" src="asset/img/personal/ps4.jpg" alt=""
                                            width="400px">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card-body text-center">
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <img src="asset/img/personal/ps2.jpg" alt="" width="500px">
                                <img src="asset/img/personal/ps3.jpg" alt="" width="500px">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card-header mb-4" style="border: 1px solid white; padding:10px">
            <span style="font-family: 'Times New Roman'; font-size:200%">PACKAGE LISTS <b>PERSONAL PHOTO
                </b></span>
        </div>
        <div class="container py-4">
            <div id="preweddingCarousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    @foreach ($personal as $key => $pw)
