                                                                ...
                                                                <td>
                                                                    ...
                                                                    @elseif($us->status_dp == 'sewa anda di tolak')
                                                                        <span class="text-white p-3 btn bg-danger">Di
                                                                            Tolak</span>
                                                                    @elseif(!$us->status_dp)
                                                                        <a href="{{ Route('transaction_dp_wed', $us->id) }}"
                                                                            class="btn btn-sm btn-warning">Upload
                                                                            Pembayaran</a>
                                                                        <form
                                                                            onclick="return confirm('Anda yakin data dihapus?');"
                                                                            class="d-inline" action="{{ route('wedding.transaction.destroy', $us->id) }}" method="post">
                                                                            @csrf
                                                                            @method('delete')
                                                                            <button type="submit"
                                                                ...
                                                                <td>
                                                                    @if ($us->status_dp == 'selesai')
                                                                        ...
                                                                        @elseif ($us->status_pay == 'selesai')
                                                                            ...
                                                                            @else
                                                                            <a href="{{ Route('transaction_dp_wed', $us->id) }}" class="btn btn-sm btn-warning">Upload Pembayaran</a>
                                                                        @endif
                                                                        @else
                                                                        <span
