    ...
    <section id="hero" class="hero d-flex flex-column justify-content-center align-items-center">
        <div class="container">
            <div class="card-header mb-4 text-center" style="border: 1px solid white; padding:10px">
                <span style="font-family: 'Times New Roman'; font-size:200%">FORM PACKAGE<b> WEDDING</b></span>
            </div>
                    ...
                    <div class="card mb-3 fullscreen-bg" style="background-image: url(/asset/img/logo/bg1.jpg)">
                        <div class="card-header text-center" style="color: white;">
                            <h5 class="card-title" style="font-family: 'Times New Roman', Times, serif">
                                <i>{{ $wedding->basic->name }} (<span>Rp.
                                        {{ number_format($wedding->price, 2, '.', ',') }}</span>)</i>
                            </h5>
                        </div>
            ...
            <div class="row gx-3 justify-content-center">
                <div class="col-md-6">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <!-- Row start -->
                            <form class="row g-3" action="{{ route('store_wedding') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="wedding_id" value="{{ $wedding->id }}">
                                <input type="hidden" name="user_id" value="{{ Auth()->user()->id }}">
                                <input type="hidden" name="basic_id" value="{{ $wedding->id }}">
                                <div class="col-md-6">
