            ...
            <div class="card-body">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                      ...
                      <form action="{{ route('transaction.upload_pay_gro', $data->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                      ...
                      @else
                      <form action="{{ route('transaction.upload_dp_gro', $data->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group text-left">
