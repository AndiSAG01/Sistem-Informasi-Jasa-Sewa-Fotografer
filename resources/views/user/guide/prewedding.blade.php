...
@section('content')
    <section id="hero" class="hero d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-3 text-center">
                                ...
                                <div class="card-body text-white rounded fullscreen-bg "
                                    ...
                                    <span style="font-family: 'Times New Roman'; font-size:200%">PREWEDDING</span>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <img class="mb-4" src="asset/img/prawed/prawed2.jpg" alt=""
                                            width="300px">
                                        <img class="mb-4" src="asset/img/prawed/prawed3.jpg" alt=""
                                            width="300px">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card-body text-center">
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <img src="asset/img/prawed/prawed1.jpg" alt="" width="500px">
                                <img src="asset/img/prawed/prawed4.jpg" alt="" width="500px">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card-header mb-4" style="border: 1px solid white; padding:10px">
            <span style="font-family: 'Times New Roman'; font-size:200%">PACKAGE LISTS <b>PREWEDDING</b></span>
        </div>
        <div class="container">
            <div id="preweddingCarousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    @foreach ($prewedding as $key => $pw)
                                ...
                                <div class="card mb-3 fullscreen-bg" style="background-image: url(asset/img/logo/bg1.jpg)">
                                    <div class="card-header text-center" style="color: white;">
                                        <h5 class="card-title" style="font-family: 'Times New Roman', Times, serif">
                                            <i>{{ $pw->basic->name }} (<span>Rp. {{ number_format($pw->price, 2, '.', ',') }}</span>)</i>
                                        </h5>
                                    </div>
                                    <div class="card-body" style="color: white;">
                                        ...
                                        <a href="{{ route('reservation_prewedding',$pw->id) }}" class="btn btn-success">Reservation</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <button class="carousel-control-prev" type="button" data-bs-target="#preweddingCarousel" data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Previous</span>
                </button>
                <button class="carousel-control-next mb-4" type="button" data-bs-target="#preweddingCarousel" data-bs-slide="next">
