        ...
        <div class="card mb-4">
            <div class="card-body bg-black">
                <div class="mb-2 d-flex align-items-end justify-content-between">
                    <h5 class="card-title">Data Transaction Package Aqiqah</h5>
                </div>
                            ...
                            @foreach ($resevasi as $no => $us)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('admin.transaksi.delete_aqiqah', $us->id) }}" method="post">
                                            @csrf
                                            @method('delete')
                                        ...
                                        @elseif($us->status_pay == 'telah di sewa')
                                        <a href="{{ Route('admin.transaksi.pay_selesai_aqiqah', $us->id) }}" class="btn btn-success">Selesai</a>
                                        @elseif($us->status_pay == 'menunggu konfirmasi')
                                        <form action="{{ Route('transaksi.confirmation_pay_aqiqah', $us->id) }}" method="post">
                                            @csrf
                                            @method('put')
                                        ...
                                        <form action="{{ Route('admin.transaksi.pay_reject_aqiqah', $us->id) }}" method="post">
                                            @csrf
                                            @method('put')
