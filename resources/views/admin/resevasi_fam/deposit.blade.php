                            ...
                            @foreach ($resevasi as $no => $us)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($us->status_dp == 'telah di sewa')
                                        <a href="{{ Route('admin.transaksi.dp_selesai_familly', $us->id) }}" class="btn btn-success">Selesai</a>
                                        @elseif($us->status_dp == 'menunggu konfirmasi')
                                        <form action="{{ Route('transaksi.confirmation_dp_familly', $us->id) }}" method="post">
                                            @csrf
                                            @method('put')
                                        ...
                                        <form action="{{ Route('admin.transaksi.dp_reject_familly', $us->id) }}" method="post">
                                            @csrf
                                            @method('put')
