        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="mb-2 d-flex align-items-end justify-content-between">
                    <h5 class="card-title">Data Package Personal</h5>
                </div>
                    ...
                    <table class="table table-striped table-bordered align-middle m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('personals.edit',$us->id) }}" class="btn btn-primary"><span class="icon-edit"></span></a>
                                    <form onclick="return confirm ('anda yakin data dihapus?');" class="d-inline" action="{{Route ('personals.destroy', $us->id )}}" method="post">
                                        @csrf
                                        @method('delete')
