                            ...
                            @foreach ($resevasi as $no => $us)
                                <tr>
                                    ...
                                    <td class="text-white">Rp.
                                        {{ number_format($us->personal->price, 2, '.', ',') }}</td>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('admin.transaksi.delete_personal', $us->id) }}" method="post">
                                            @csrf
                                            @method('delete')
                                        ...
                                        @elseif($us->status_pay == 'telah di sewa')
                                        <a href="{{ Route('admin.transaksi.pay_selesai_personal', $us->id) }}" class="btn btn-success">Selesai</a>
                                        @elseif($us->status_pay == 'menunggu konfirmasi')
                                        <form action="{{ Route('transaksi.confirmation_pay_personal', $us->id) }}" method="post">
                                            @csrf
                                            @method('put')
                                        ...
                                        <form action="{{ Route('admin.transaksi.pay_reject_personal', $us->id) }}" method="post">
                                            @csrf
                                            @method('put')
