    ...
    <div class="col-lg-12">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('groups') }}">Package Group Photo</a></li>
                <li class="breadcrumb-item"><a href="">Edit</a></li>
                <li class="breadcrumb-item"><a href="">{{ $group->basic->name }}</a></li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="card-body">
        <div class="card">
            <div class="card-body text-center">
                <h5 class="card-title mb-4">Update Package Group Photo</h5>
                <div class="alert bg-primary text-white mb-4" role="alert">
                    <span class="modal-title" id="exampleModalLabel">
                      <h5 class="fw-bold"><i class="fas fa-exclamation-triangle"> PERINGATAN!!!</i>
                        ...
                        <small>Pastikan Anda telah menentukan Group Photo. Manage package Group Photo mempengaruhi jenis dari
                ...
                <div class="card-body">
                    <form action="{{ route('groups.update', ['id' => $group->id]) }}" method="POST">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea name="description" id="editor" cols="30" rows="10">{!! $group->description !!}</textarea>
                        </div>
                        <div class="form-group mb-4">
                            <label for="">Price</label>
                            <input type="number" name="price" class="form-control" value="{{ $group->price }}">
                        </div>
