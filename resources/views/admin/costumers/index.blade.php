                    ...
                    <table class="table table-striped table-bordered align-middle m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('costumers.detail',$us->id) }}" class="btn btn-primary"><span class="icon-find_in_page"> Detail</span></a>
                                    <form onclick="return confirm ('anda yakin data dihapus?');" class="d-inline" action="{{Route ('costumers.destroy', $us->id )}}" method="post">
                                        @csrf
                                        @method('delete')
