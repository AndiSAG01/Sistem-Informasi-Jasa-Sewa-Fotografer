...
<div class="row mb-3">
    <div class="col-lg-12">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item text-black"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item text-black"><a href="#">PreWedding</a></li>
            </ol>
        </nav>
    </div>
</div>
        ...
        <div class="card mb-4">
            <div class="card-body bg-black">
                <div class="mb-2 d-flex align-items-end justify-content-between">
                    <h5 class="card-title">Data Package PreWedding</h5>
                </div>
               @include('admin.prewedding.create')
                    ...
                    <table id="example" class="table table-striped table-bordered align-middle m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('preweddings.edit',$us->id) }}" class="btn btn-primary"><span class="icon-edit"></span></a>
                                    <form onclick="return confirm ('anda yakin data dihapus?');" class="d-inline" action="{{Route ('preweddings.destroy', $us->id )}}" method="post">
                                        @csrf
                                        @method('delete')
