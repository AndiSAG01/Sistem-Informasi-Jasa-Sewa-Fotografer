                            ...
                            @foreach ($resevasi as $no => $us)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($us->status_pay == 'telah di sewa')
                                        <a href="{{ Route('admin.transaksi.pay_selesai_group', $us->id) }}" class="btn btn-success">Selesai</a>
                                        @elseif($us->status_pay == 'menunggu konfirmasi')
                                        <form action="{{ Route('transaksi.confirmation_pay_group', $us->id) }}" method="post">
                                            @csrf
                                            @method('put')
                                        ...
                                        <form action="{{ Route('admin.transaksi.pay_reject_group', $us->id) }}" method="post">
                                            @csrf
                                            @method('put')
